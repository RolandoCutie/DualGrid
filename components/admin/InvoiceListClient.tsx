                    ...
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <div className="relative">
                        <button
                          ...
                          className="w-7 h-7 flex items-center justify-center rounded-lg border border-border text-muted-foreground hover:bg-muted hover:text-card-foreground transition-colors"
                        >
                        ...
                        {openMenuId === inv._id && (
                          <>
                            ...
                            />
                            <div className="absolute right-0 top-8 z-40 w-36 rounded-xl border border-border bg-card shadow-xl overflow-hidden">
                              <Link
                                href={`/admin/dashboard/invoices/${inv._id}`}
                                onClick={() => setOpenMenuId(null)}
                                className="flex items-center gap-2 px-3 py-2.5 text-sm text-card-foreground hover:bg-muted transition-colors"
                              >
                                <svg
                                  width="13"
                                  height="13"
                              ...
                              <button
                                type="button"
                                onClick={() => {
                                  setConfirm({ id: inv._id, name: inv.invoiceNumber });
                                  setOpenMenuId(null);
                                }}
