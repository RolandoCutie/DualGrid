          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{
                  background: 'radial-gradient(circle, rgba(0,217,255,0.16) 0%, transparent 65%)',
                  filter: 'blur(50px)',
                }}
                aria-hidden="true"
              />
              <div
                ...
                style={{
                  background: 'radial-gradient(circle, rgba(0,255,157,0.15) 0%, transparent 65%)',
                  filter: 'blur(50px)',
                }}
                aria-hidden="true"
              />
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  {WHATSAPP_NUM && (
                    <a
                      href={`https://wa.me/${WHATSAPP_NUM.replace(/\D/g, '')}?text=${encodeURIComponent('¡Hola! Me gustaría hablar sobre un proyecto.')}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-xl text-sm font-semibold border transition-all duration-200 hover:scale-[1.02]"
                      style={{
