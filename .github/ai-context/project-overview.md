...
| **Plans Catalog**              | 5 plans defined in `lib/plans.ts`: Landing, Menú QR, Portfolio, Restaurant, Custom. Web development cards are now collapsible: CTA first, then “Ver todas las características” accordion.                                                                                                |
