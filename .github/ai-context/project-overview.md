...
| Feature                        | Description                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Landing Page**               | Hero with dual CTAs (web + branding), service overview, portfolio, process, unified plan cards for web/branding/hosting/domain, testimonials, and final CTA. The landing copy now frames DualGrid explicitly as a two-person team (designer + software engineer) rather than a large agency. Dark mode uses a cinematic multi-layer neon gradient background across all landing sections.                                   |
